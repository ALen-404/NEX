...
import { ArgentWalletDetector, EnsPublicResolver, EnsRegistrar, Erc20, Erc721, Erc1155, Weth, Xen } from 'abis/types'
import WETH_ABI from 'abis/weth.json'
import Xen_ABI from 'abis/xen.json'
import {
...
export function useXenContract(contractAddress: string) {
  return useContract<Xen>(contractAddress, Xen_ABI, true)
}
